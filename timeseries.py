...
# unpacking matrix into 1 dimensional array
...
train_steps = tf.train.AdagradOptimizer(0.3).minimize(total_loss)
...
with tf.Session() as sess:
 	...
 	for epoch_idx in range (num_epochs):
 		...
 		for batch_idx  in range (num_batches):
 			...
 			_total_loss, _train_steps, _current_state, _predictions_series = sess.run(
                [total_loss, train_steps, current_state, predictions_series],
                feed_dict={
